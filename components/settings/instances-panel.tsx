...
import { fetchInstances, createInstance, updateInstance } from "@/lib/services/instances"
      ...
      <Card>
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              <TableRow>
                <TableCell colSpan={11}>Carregando instâncias...</TableCell>
              </TableRow>
            ) : instances.length === 0 ? (
              <TableRow>
                <TableCell colSpan={11}>Nenhuma instância cadastrada.</TableCell>
              </TableRow>
            ) : (
